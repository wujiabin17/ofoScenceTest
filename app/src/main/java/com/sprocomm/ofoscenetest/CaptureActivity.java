...
import com.sprocomm.ofoscenetest.camera.CameraManager;
import com.sprocomm.ofoscenetest.decode.BeepManager;
import com.sprocomm.ofoscenetest.decode.CaptureActivityHandler;
import com.sprocomm.ofoscenetest.decode.InactivityTimer;
import com.sprocomm.ofoscenetest.result.ResultHandler;
import com.sprocomm.ofoscenetest.result.ResultHandlerFactory;
import com.sprocomm.ofoscenetest.utils.Config;
import com.sprocomm.ofoscenetest.utils.ConstValue;
import com.sprocomm.ofoscenetest.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private void initView() {
        ...
        imageBack = (ImageButton)findViewById(R.id.capture_imageview_back);
        opreateView.setOnClickListener(this);
...
//            viewfinderView.drawResultBitmap(barcode);
        ...
        intent.putExtra(ConstValue.RETURN_BYCLE_ID,text);
        setResult(ConstValue.REQUEST_FROM_MOBILE_BYCLE,intent);
        Toast.makeText(this,"获得id:"+text, Toast.LENGTH_SHORT).show();
